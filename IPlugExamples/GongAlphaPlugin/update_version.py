...
def main():
  ...
  CFBundleGetInfoString = FullVersionStr + ", Copyright RichardGong, " + str(today.year)
  CFBundleVersion = FullVersionStr
  
  print "update_version.py - setting version to " + FullVersionStr
  print "Updating plist version info..."
  
  plistpath = scriptpath + "/resources/GongAlphaPlugin-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/GongAlphaPlugin-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/GongAlphaPlugin-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/GongAlphaPlugin-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/GongAlphaPlugin-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/GongAlphaPlugin-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/GongAlphaPlugin-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/GongAlphaPlugin.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/GongAlphaPlugin.iss",inplace=1):
